...
import { Timestamp, addDoc, collection, getDocs, query, where, updateDoc } from 'firebase/firestore';
...
return (
  <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
    <div className="bg-gray-900 rounded-2xl border border-purple-500/50 w-full max-w-md relative 
                    max-h-[90vh] overflow-y-auto p-8 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent">
      <button
        onClick={onClose}
      ...
      <form className="space-y-4" onSubmit={handleSignup}>
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-gray-800 rounded-lg border border-gray-700 text-white 
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-gray-800 rounded-lg border border-gray-700 text-white 
                       focus:border-purple-500 focus:ring-purple-500 pr-10"
          />
          <button
            type="button"
      ...
      <button
        ...
        className="w-full border border-gray-700 hover:border-gray-600 text-white py-3 flex 
